...
class DistancePopup(GenericPopup):
    def __init__(self, master):
        ...
        button_50 = tk.Button(self, text="50m", command=lambda: self.button_press("50 m"))
        button_50.place(relx=.3, rely=.8, anchor='c')

        button_80 = tk.Button(self, text="80m", command=lambda: self.button_press("80 m"))
        button_80.place(relx=.7, rely=.8, anchor='c')
